...
const PaymentPage = () => {
  ...
  return (
    <div className="grid lg:grid-cols-[2fr_1fr] sm:grid-cols-1 gap-4 mb-16">
      <div className="bg-primary-grey-light-2 grid gap-6 px-10 sm:px-24 lg:px-10 py-16 h-fit">
      ...
      <div className="bg-primary-grey-light-2 py-16 px-10 sm:px-24 lg:px-10 h-fit">
