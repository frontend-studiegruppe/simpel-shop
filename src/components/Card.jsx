  ...
  return (
    ...
    <div className="group max-w-[250px]">
      <div className="relative">
        {product.discountPercentage > 10 && (<div className="bg-secondary-cherry-light/30 text-secondary-cherry-dark font-bold w-fit px-2 py-1 absolute top-0 left-0 z-20">
        ...
        <Image src={product.thumbnail || "/placeholder.png"} alt={product.title} width={250} height={250} className="object-cover bg-white" />
        </div>
      ...
      {product.availabilityStatus === "Low Stock" && (<p className="text-secondary-cherry-light font-semibold text-sm">pssst... Low Stock</p>)}
    </div>
    </Link>
  );
};
