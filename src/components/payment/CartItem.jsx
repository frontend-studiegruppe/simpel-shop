...
const CartItem = () => {
  return (
    <div className="bg-primary-grey-light-3 flex flex-col md:flex-row p-8 justify-between gap-6">
      <Image
        src={exampleImg}
        alt="eksempel"
      ...
      <div className="flex sm:flex-row md:flex-col items-end justify-between">
        ...
        <PiTrashLight
          size={34}
          className="text-secondary-cherry-dark hover:text-secondary-cherry-light cursor-pointer"
        ></PiTrashLight>
      </div>
    </div>
  );
